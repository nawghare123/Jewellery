...
class CraeteprofileSeller extends StatefulWidget {
   CraeteprofileSeller({super.key, this.role});
  String? role;

  @override
  State<CraeteprofileSeller> createState() => _CraeteprofileSellerState();
}

class _CraeteprofileSellerState extends State<CraeteprofileSeller> {
