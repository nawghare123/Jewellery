...
class MyCartConfrim extends StatefulWidget {
  const MyCartConfrim({super.key});

  @override
  State<MyCartConfrim> createState() => _MyCartConfrimState();
}

class _MyCartConfrimState extends State<MyCartConfrim> {
...
//   }
  Future<void> getUserData() async {
    ...
    print(
        "userid $userId, state $state, city $city, address $address, pincode $pincode");
    setState(() {});
  }
    ...
    try {
      ...
      getCardModel!.data!.forEach((e) {
        ...
        List<Map<String, dynamic>>.from(json.decode(e.variant!
          ...
          // thisVar = e["price"] * e["quantity"];
          // print("Quan : ${e["quantity"]}, vari: ${e["variant"]}");
                ...
                child: ListView(
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                          gradient:
                              LinearGradient(colors: [gradient2, gradient1])),
                      child: Padding(
                                                                ...
                                                                List<
                                                                    ...
                                                                    .replaceAllMapped(
                                                                        RegExp(
                                                                            r'(\w+):'),
                                                                        (match) =>
                                                                            '"${match.group(1)}":'))).forEach(
                                                                    (e) {
                                                                  print(
                                                                      "Quan : ${e["quantity"]}, vari: ${e["variant"]}");
                                                                  ...
                                                                  builder:
                                                                    ...
                                                                    return AlertDialog(
                                                                      title: Column(
                                                                          ...
                                                                          children: [
                                                                            Image.asset("assets/image/cartimg1.png",
